...
# Visual 2: D.C. Robberies per Shift, 2008-2025
```{r, echo=FALSE, warning=FALSE, message=FALSE}
dc.robbery <- subset(dc.data, dc.data$OFFENSE == 'ROBBERY')
ggplot(dc.robbery, aes(SHIFT)) + geom_bar(stat = "count") +
    labs(title = "D.C. Robberies per Shift \n2008 - 2025", x = "Shift", 
       y = "Robbery Count")
```
