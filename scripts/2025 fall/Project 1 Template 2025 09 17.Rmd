...
### Finding 1: Crime Types
Each finding should be 4+ sentences, and describe something specific about the data:
At least one finding about crime type(s)
Each find should include a specific statistical reference

### Finding 2: Locations
Each finding should be 4+ sentences, and describe something specific about the data:
At least one finding about location(s)
Each find should include a specific statistical reference

### Finding 3: Time
Each finding should be 4+ sentences, and describe something specific about the data:
At least one finding about time(s)
Each find should include a specific statistical reference
